...
source_path = "/data4/liandong/datasets/MTG-Jamendo"
target_sampling_rate = 24000
target_len = 8.0
target_path = "/data4/liandong/datasets/MTG-Jamendo_{}k".format(target_sampling_rate//1000)
if not os.path.exists(target_path):
   os.makedirs(target_path)

source_list = glob(f"{source_path}/*/*.mp3")
